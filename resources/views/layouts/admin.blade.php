    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="{{url('ventas/venta')}}" class="logo">
          ...
          <span class="logo-mini"><b>ICO</b></span>
          <!-- logo for regular state and mobile devices -->
          <img src="{{asset('img/Icoplas.png')}}" width="200px" height="50px">
          <!--<span class="logo-lg"><b>ICOPLAS</b></span> -->
        </a>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs">Diego Fernando Agreda Hidalgo</span>
                </a>
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p>
                      Creado por: Diego Fernando Agreda Hidalgo
                      <small>2020</small>
                    </p>
                  </li>
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2020 <a href="http://icoplaspasto.blogspot.com/">Almacén Icoplas-Pasto</a>.</strong> All rights reserved.
      </footer>
