...
@section ('contenido')
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <h3>Editar Proveedor: {{$persona->nombre}}</h3> <!-- le damos persona->nombre porque en el controlador ClienteController el metodo edit nos retorna un objeto llamado 'persona' -->
            @if(count($errors)>0)
    ...
    {!!Form::model($persona,['method'=>'PATCH','route'=>['proveedor.update',$persona->idpersona]])!!}   <!-- Se utiliza el metodo PATCH porque es el encargado de llamar al metodo update en el controllador ClienteController, y en route revisamos como es el nombre de la ruta que queremos con php artisan route:list -->
    {!!Form::token()!!}
    <div class="row">
