...
class ProveedorController extends Controller
{
    ...
    public function index(Request $request){
        if($request){ //si existe el objeto request entonces: voy a obtener todos los registros de la tabla persona de la base de datos
            ...
            ->where('tipo_persona','=','Proveedor') //donde la condicion sea igual a 1 osea las categorias activas 
    ...
    public function create(){
        return view("compras.proveedor.create");//retorna la vista create
    }
    ...
    public function store(PersonaFormRequest $request){
        ...
        $persona->tipo_persona='Proveedor';//cuando registre desde el formulario registrar cliente el tipo_perona va a ser Cliente 
        ...
        return Redirect::to('compras/proveedor');//para que despues de almacenar nos redireccione a la vista index de los clientes que es donde se va a listar todas los clientes que existen.
    }

    //definimos el metodo show para mostrar, recibe un parametro que es el id de la persona que quiero mostrar
    public function show($id){
        return view("compras.proveedor.show",["persona"=>Persona::findOrFail($id)]);/*retorna la vista show la cual mostrara la categoria que tiene el id que se le envia como parametro*/
    }

    //definimos el metodo edit para editar, recibe un parametro que es el id de la persona que quiero editar
    public function edit($id){
        return view("compras.proveedor.edit",["persona"=>Persona::findOrFail($id)]);/*retorna la vista edit la cual mostrara la categoria que tiene el id que se le envia como parametro*/
    }
    ...
    public function update(PersonaFormRequest $request,$id){
        ...
        return Redirect::to('compras/proveedor');// redirigimos a la vista categoria
    }
    ...
    public function destroy($id){
        ...
        $persona->update();// llamamos al metodo update para actualizar el objeto 'persona'
        return Redirect::to('compras/proveedor');// redirigimos a la vista index de cliente
    }
}
